...
/**
 * Title: FAQ Accordion Dark
 * Slug: modestra/faq-accordion-dark
 * Categories: modestra-accordion
 */
?>
<!-- wp:group {"metadata":{"categories":["modestra-accordion"],"patternName":"modestra/faq-list-dark","name":"FAQ Section"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"120px","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}}},"backgroundColor":"dark-shade","layout":{"type":"constrained","contentSize":"780px"}} -->
<div class="wp-block-group has-dark-shade-background-color has-background" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--40);padding-bottom:120px;padding-left:var(--wp--preset--spacing--40)"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|40","margin":{"bottom":"48px"}}},"layout":{"type":"constrained"}} -->
    ...
    <div class="wp-block-group" style="margin-top:0px"><!-- wp:details {"className":"is-style-default","style":{"typography":{"fontStyle":"normal","fontWeight":"500"},"elements":{"link":{"color":{"text":"var:preset|color|light-color"}}},"spacing":{"padding":{"top":"16px","bottom":"16px","left":"20px","right":"20px"}},"border":{"width":"1px"}},"textColor":"light-color","fontSize":"medium"} -->
        <details class="wp-block-details is-style-default has-light-color-color has-text-color has-link-color has-medium-font-size" style="border-width:1px;padding-top:16px;padding-right:20px;padding-bottom:16px;padding-left:20px;font-style:normal;font-weight:500">
            <summary><?php esc_html_e('What is Full Site Editing in WordPress?', 'modestra') ?></summary><!-- wp:paragraph {"placeholder":"Type / to add a hidden block","style":{"typography":{"fontStyle":"normal","fontWeight":"400"},"elements":{"link":{"color":{"text":"var:preset|color|light-color"}}}},"textColor":"light-color","fontSize":"normal","fontFamily":"urbanist"} -->
        ...
        <!-- wp:details {"className":"is-style-default","style":{"typography":{"fontStyle":"normal","fontWeight":"500"},"elements":{"link":{"color":{"text":"var:preset|color|light-color"}}},"spacing":{"padding":{"top":"16px","bottom":"16px","left":"20px","right":"20px"}},"border":{"width":"1px"}},"textColor":"light-color","fontSize":"medium"} -->
        <details class="wp-block-details is-style-default has-light-color-color has-text-color has-link-color has-medium-font-size" style="border-width:1px;padding-top:16px;padding-right:20px;padding-bottom:16px;padding-left:20px;font-style:normal;font-weight:500">
            <summary><?php esc_html_e('What are the benefits of Full Site Editing in WordPress?', 'modestra') ?></summary><!-- wp:paragraph {"placeholder":"Type / to add a hidden block","style":{"typography":{"fontStyle":"normal","fontWeight":"400"},"elements":{"link":{"color":{"text":"var:preset|color|light-color"}}}},"textColor":"light-color","fontSize":"normal","fontFamily":"urbanist"} -->
        ...
        <!-- wp:details {"className":"is-style-default","style":{"typography":{"fontStyle":"normal","fontWeight":"500"},"elements":{"link":{"color":{"text":"var:preset|color|light-color"}}},"spacing":{"padding":{"top":"16px","bottom":"16px","left":"20px","right":"20px"}},"border":{"width":"1px"}},"textColor":"light-color","fontSize":"medium"} -->
        <details class="wp-block-details is-style-default has-light-color-color has-text-color has-link-color has-medium-font-size" style="border-width:1px;padding-top:16px;padding-right:20px;padding-bottom:16px;padding-left:20px;font-style:normal;font-weight:500">
            <summary><?php esc_html_e('How do I enable Full Site Editing in WordPress?', 'modestra') ?></summary><!-- wp:paragraph {"placeholder":"Type / to add a hidden block","style":{"typography":{"fontStyle":"normal","fontWeight":"400"},"elements":{"link":{"color":{"text":"var:preset|color|light-color"}}}},"textColor":"light-color","fontSize":"normal","fontFamily":"urbanist"} -->
