 ...
 * Slug: modestra/featured-content-2
...
<div class="wp-block-group has-light-color-background-color has-background" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--40)"><!-- wp:columns {"style":{"spacing":{"blockGap":{"left":"48px"}}}} -->
    <div class="wp-block-columns"><!-- wp:column -->
        <div class="wp-block-column"><!-- wp:cover {"url":"<?php echo esc_url($modestra_images[0]) ?>","id":7674,"dimRatio":0,"customOverlayColor":"#c2c0c0","minHeight":340,"isDark":false,"className":"is-style-modestra-cover-modestra-zoom-effect","style":{"color":{"duotone":"unset"},"border":{"radius":"0px"}},"layout":{"type":"constrained"}} -->
            ...
            <!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"top":"28px"}},"typography":{"fontSize":"28px"}}} -->
            <h3 class="wp-block-heading" style="margin-top:28px;font-size:28px"><?php esc_html_e('Featured Title', 'modestra') ?></h3>
            <!-- /wp:heading -->
