...
/**
 * Title: Portfolio Gallery columns 2
 * Slug: modestra/porftfolio-gallery-2
...
<div class="wp-block-group" style="padding-top:100px;padding-right:var(--wp--preset--spacing--40);padding-bottom:100px;padding-left:var(--wp--preset--spacing--40)"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|30","margin":{"bottom":"48px"}}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->
    ...
    <!-- wp:gallery {"columns":2,"linkTo":"none","sizeSlug":"full","className":"is-style-enable-grayscale-mode-on-image"} -->
    <figure class="wp-block-gallery has-nested-images columns-2 is-cropped is-style-enable-grayscale-mode-on-image"><!-- wp:image {"id":4619,"sizeSlug":"full","linkDestination":"none"} -->
        <figure class="wp-block-image size-full"><img src="<?php echo esc_url($modestra_images[0]) ?>" alt="" class="wp-image-4619" /></figure>
        <!-- /wp:image -->

        <!-- wp:image {"id":4606,"sizeSlug":"full","linkDestination":"none"} -->
        <figure class="wp-block-image size-full"><img src="<?php echo esc_url($modestra_images[1]) ?>" alt="" class="wp-image-4606" /></figure>
        <!-- /wp:image -->
    </figure>
    <!-- /wp:gallery -->
</div>
