(function ($) {
  ...
  $("#install-activate-button").on("click", function (e) {
    ...
    var activationData = {
      action: "modestra_install_and_activate_plugins",
      nonce: modestra_localize.nonce,
    };
    $.post(modestra_localize.ajax_url, activationData, function (response) {
      ...
      if (match) {
        ...
        try {
          ...
          if (responseObj.success === true) {
            window.location.href = modestra_localize.redirect_url;
          } else {
            console.log("Error!");
          }
        } catch (error) {
